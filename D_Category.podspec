...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/xdwly/D_Category"
  ...
  s.source       = { :git => "https://github.com/xdwly/D_Category.git", :tag => s.version.to_s }
  ...
  s.source_files  = "D_Category/D_Category/**/*.{h,m,swift}"
